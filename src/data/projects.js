...
const myprojects_data = [
  ...
  },
  {
    ...
    description:
      "NewsShorts is a news app which can be used to grab quick daily news bites. Stay updated with business, health, sports, technology and all kinds of current affairs. This app use GnewsApi resources to fetch data.",
  },
  {
    p_no: 3,
    p_img: city_weather1,
    ...
    title: "Weather App",
    subtitle: "Vue + Tailwind + openweathermap",
    description:
